...
export const ProductSlider = ({ carouselTitle, products }: ProductSliderProps) => {
    return (
        <div className="my-8 w-full px-5 sm:my-12 lg:px-10">
            <h5 className="mb-4 text-lg font-[700] text-[#0F2744] exo sm:mb-5 sm:text-xl md:text-[2rem]">{carouselTitle}</h5>
                ...
                <Carousel>
                    <CarouselContent>
                        ...
                        <CarouselItem className="h-auto basis-[300px] pl-4">
                            ...
                            >
                                <div className="flex h-full w-full items-center justify-center gap-2 rounded-xl border border-[#0F2744]/20 bg-[#F6F7F9] p-3 text-base font-semibold text-[#0F2744] shadow-sm transition hover:bg-[#dbe7f4] raleway sm:p-4 sm:text-2xl">
                                    View All
                                    <ArrowRight />
                                </div>
                            </Link>
