...
export function BottomNavigationClient({ isSignedIn }: BottomNavigationClientProps) {
    ...
    return (
        ...
        >
            <div
                className="pointer-events-auto mx-3 flex max-w-md items-stretch justify-between gap-1 rounded-2xl border border-[#212121]/14 bg-white/90 px-1 py-1 shadow-[0_2px_16px_rgba(33, 33, 33,0.12)] backdrop-blur-sm"
                style={{
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            {active ? (
                                <span
                                    className="absolute inset-x-2 inset-y-1 rounded-lg bg-[#212121]/10"
                                    aria-hidden
                                />
                            ) : null}
                            <Icon
                                className={cn(
                                    ...
                                    active ? "text-[#212121]" : "text-neutral-400"
                                )}
