                    ...
                    <div className="w-full lg:flex lg:items-start gap-10">
                        ...
                        <div className="flex-1 flex flex-col gap-y-5 justify-between mt-5 lg:mt-0">
                            <div>
                                ...
                                <h5 className="mt-3 flex gap-3 text-base font-semibold text-[#0F2744] sm:gap-4 sm:text-lg lg:text-xl">{"\u20B9"} {activeOriginalPrice}  <span className="line-through text-muted-foreground !font-[300]">{"\u20B9"} {activeDiscountPrice}</span></h5>
                                <p className=" text-sm text-green-600 mb-4 exo mt-2">inclusive of all taxes</p>

                                {isSelectedOutOfStock ? (
                                    <p className="text-sm font-medium text-[#0F2744] raleway rounded-md border border-[#0F2744]/20 bg-[#F6F7F9] px-3 py-2 mb-2">
