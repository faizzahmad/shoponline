        ...
        <>
            ...
            <div className="h-auto w-full">
                <div className="w-full">
                    ...
                    <div className="mt-10 flex flex-wrap sm:grid grid-cols-[repeat(auto-fill,_minmax(200px,_1fr))] gap-y-5 gap-x-5 ">
                            ...
                            products.map((item, index) => (
                                <ProductCard
                                    ...
                                    description={item.shortDescription}
                                     divCalssName="sm:w-full w-[180px]"
                                    imageContainerClassName="relative md:h-[200px] h-[180px] w-full"
                                />
                            ))
...
const ProductCardSkeleton = () => {
    return (
        <div className="w-full p-4 shadow-sm rounded-xl bg-indigo-50">
            <div className="md:h-[200px] h-[150px]">
